...
| Video tối đa mỗi tệp | 100 MB | Biến `MAX_VIDEO_MB` trong `.env`; Nginx phải cho phép lớn hơn (`client_max_body_size 110m`) |
...
| Tải video báo lỗi 413 | Nginx chặn tệp lớn | Thêm `client_max_body_size 110m;` vào cấu hình site API |
